...
export const QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: "A few times a week", value: 30 },
      { label: "Occasionally", value: 10 },
      { label: "Rarely or never", value: 0 },
    ],
  },
  {
    ...
    tipKey: "salt",
    options: [
      { label: "Sea salt", value: 15 },
      { label: "Table salt or mixed", value: 5 },
      { label: "Rock salt or Himalayan", value: 2 },
      { label: "I don't use salt", value: 0 },
    ],
  },
  {
    id: "canned",
    ...
    tipKey: "canned",
    options: [
      { label: "Daily", value: 350 },
      { label: "Several times a week", value: 175 },
      { label: "Occasionally", value: 50 },
      { label: "Rarely or never", value: 0 },
    ],
  },
  {
    id: "hotdrinks",
    category: "kitchen",
    question: "Do you drink hot drinks from disposable paper cups or plastic cups?",
    tipKey: "hotdrinks",
    options: [
      { label: "Daily", value: 1400 },
      { label: "A few times a week", value: 600 },
      { label: "Occasionally", value: 150 },
      { label: "Never — I use a reusable cup or mug", value: 0 },
    ],
  },
  {
    id: "clothing",
...
export const REDUCTION_TIPS: Record<string, string> = {
  ...
  canned: "Can linings contain epoxy resin and trace plastics that leach into food, particularly with acidic contents (tomatoes, fizzy drinks). Reducing canned food in favour of fresh, frozen, or glass-jarred alternatives lowers this exposure pathway.",
  hotdrinks: "Disposable paper cups have a thin plastic polyethylene lining that releases microplastics into hot liquids. Switching to a reusable ceramic or stainless steel cup eliminates this source entirely.",
  ...
  beer: "Microplastic fibres in beer are attributed to airborne deposition during the brewing process. Reducing consumption or choosing alternatives reduces this exposure pathway.",
  salt: "Switching from sea salt to rock salt or Himalayan salt could marginally reduce your microplastic intake — sea salt consistently shows higher contamination than mined salts in peer-reviewed studies.",
};
