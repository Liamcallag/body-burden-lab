...
export const QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    studyCallout: {
      value: "2,409–4,964",
      unit: "microplastic particles per year recovered from food cooked in PTFE pans",
      citation: "Cole et al., Science of the Total Environment, 2024",
      caveat: "Measured using food simulant through a full cooking cycle — new pans ~2,409/year, old/worn pans ~4,964/year. Stainless steel and glass released zero.",
      url: "https://doi.org/10.1016/j.scitotenv.2024.172577",
      unitContext: "per year",
    },
    options: [
  ...
  },
{
  ...
  },
  {
    id: "canned",
    category: "food",
    question: "How often do you drink canned beverages?",
    resultLabel: "Canned beverages",
    weight: 4,
    tipKey: "canned",
    studyCallout: {
      value: "~134",
      ...
      caveat: "Tested 73 beverages across container types — canned drinks ranked second-highest for microplastic content, above PET bottles (95/L) but below glass (151/L). PP was the dominant polymer.",
...
export const REDUCTION_TIPS: Record<string, string> = {
  ...
  canned: "Canned beverages release microplastics into the drink. Switching to glass bottles or filtered tap water reduces this exposure route.",
