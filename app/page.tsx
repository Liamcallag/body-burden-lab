      ...
      <section className="py-14 px-4 sm:px-6 bg-slate-50">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            {[
              { slug: "how-to-avoid-microplastics", title: "How to Avoid Microplastics: The Highest-Impact Changes, Ranked", tag: "Guide", image: "/blog-avoid.jpg" },
              { slug: "what-do-microplastics-do-to-the-body", title: "What Do Microplastics Do to the Human Body? The Research So Far", tag: "Science", image: "/blog-how-many.jpg" },
              { slug: "how-many-microplastics-do-you-consume", title: "How Many Microplastics Do You Consume Per Week?", tag: "Science", image: "/blog-bottled-water.jpg" },
            ].map((post) => (
