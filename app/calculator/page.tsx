...
export const metadata: Metadata = {
  ...
  description:
    "Answer 12 questions about your diet and habits and get a personalised estimate of your weekly microplastic exposure — based on peer-reviewed science.",
  alternates: {
...
const schema = {
  ...
  "description": "A free calculator that estimates your weekly microplastic particle intake based on peer-reviewed science. Answer 12 questions about your daily habits and get a personalised exposure estimate.",
