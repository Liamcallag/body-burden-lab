...
export default function BlogPost() {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "Microplastics in Tea Bags: How Many You're Drinking and What to Use Instead", "item": "https://www.bodyburdenlab.com/blog/microplastics-in-tea-bags" },
  ]
}) }} />
      <div className="mb-8">
