    ...
    <article className="max-w-2xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="bg-teal-50 border border-teal-100 rounded-xl p-5 mb-8 flex items-center justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="text-xs text-slate-500">10 questions, 2 minutes, no account needed</p>
        </div>
        <Link
          href="/calculator"
      ...
      <div className="bg-teal-700 rounded-2xl p-6 mt-10 text-white text-center">
        ...
        <p className="text-teal-200 text-sm mb-4">10 questions · 2 minutes · peer-reviewed science</p>
        <Link
          href="/calculator"
