...
export default function BlogPost() {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "name": "How Many Microplastics Do You Consume Per Week? What the Research Shows", "item": "https://www.bodyburdenlab.com/blog/how-many-microplastics-do-you-consume" },
  ]
}) }} />
      {/* Header */}
      <div className="mb-8">
      ...
      <div className="bg-teal-50 border border-teal-100 rounded-xl p-5 mb-8 flex items-center justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="text-xs text-slate-500">12 questions, 2 minutes, no account needed</p>
        </div>
        <Link
          href="/calculator"
      ...
      <div className="prose prose-slate max-w-none text-[15px] leading-relaxed text-slate-700 space-y-5">
        ...
        <p>
          The Body Burden microplastics calculator takes 12 questions about your specific habits and gives you a personalised weekly particle estimate, a breakdown by source, and your top reduction opportunities — all based on the peer-reviewed studies referenced in this article.
        </p>
