    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
      ...
      <section className="mb-12">
        ...
        <div className="prose prose-slate max-w-none text-sm text-slate-600 leading-relaxed space-y-3">
          <p>
            The calculator presents 14 questions covering the major documented pathways for human microplastic exposure: drinking water, food preparation, diet, clothing, and indoor air. Each answer maps to a weekly particle estimate derived from the relevant published study.
          </p>
          <p>
