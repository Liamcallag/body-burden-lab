...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/blog/microplastics-in-the-brain`, lastModified: "2026-05-13", changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/blog/microplastics-and-heart-disease`, lastModified: "2026-05-13", changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/blog/microplastics-and-pregnancy`, lastModified: "2026-05-13", changeFrequency: "monthly", priority: 0.8 },
  ];
}
